		...
		<table>
			...
			<tr>
				<td colspan="4" align="right">
					<a href="memberboardUpdatePassword.bbs?num=${boardRead.num}">[수정]</a>
					<a href="memberboardDeletePassword.bbs?num=${boardRead.num}">[삭제]</a>
					<a href="memberboardReplyForm.bbs?num=${boardRead.num}">[답글]</a>
				</td>
			</tr>
		</table>
	</body>

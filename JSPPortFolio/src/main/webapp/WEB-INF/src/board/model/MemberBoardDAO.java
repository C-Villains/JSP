...
public class MemberBoardDAO {
	...
	// �Խñ� ���� ��� ����	
	public MemberBoardDTO boardRead(String inputNum){
		
		MemberBoardDTO writing = new BoardDTO();
	...
	// �Խñ� ���� ��� ����
	public void MemberboardUpdate(String inputNum, String inputSubject, String inputContent, String inputName, String inputPassword){
		Connection conn = null;
		PreparedStatement pstmt = null;
	...
	// �Խñ� ���� �� ������ ���� ��й�ȣ Ȯ�� ��� ��ȸ
	public boolean MemberboardPasswordCheck(String inputNum, String inputPassword){
	...
	// �� ���� ȭ�鿡 �ʿ��� ���� ������ ��ȸ ���
	public MemberBoardDTO boardUpdateForm(String inputNum){
	...
	// �Խñ� ���� ��� ����
	public void MemberboardDelete(String inputNum){
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	// ���� ����� �Խñۿ� ����� ���� ������ �˻�
	public boolean MemberboardReplyCheck(String inputNum){
	...
	// �Խñ��� ����� ���, ���۵��� ��� ������ �ٿ��ִ� ��� ����
	public void MemberboardDeleteChildCntUpdate(int ref, int lev, int step){
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
	...
	// �˻� ��� ����
	public ArrayList<MemberBoardDTO> boardSearch(String searchOption, String searchWord){
		ArrayList<MemberBoardDTO> list = new ArrayList<BoardDTO>();
	...
	// ��� �ۼ��� �ʿ��� ���� ������ ��ȸ ���
	public MemberBoardDTO boardReplyForm(String inputNum){
		MemberBoardDTO writing = new BoardDTO();
	...
	// ��� ��� ��� ����
	public void MemberboardReply(String num, String name, String subject, String content, String password, String ref, String step, String lev){
	...
	// ����� ��� ��ġ (step) ���� ��� ����
	public int MemberboardReplySearchStep(String ref, String lev, String step){
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		int replyStep=0;
	...
	// ��� �ۼ� ��, ���۵��� ��� ������ �÷��ִ� ��� ����
	public void MemberboardReplyChildCntUpdate(String ref, String lev, int replyStep){
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = null;
